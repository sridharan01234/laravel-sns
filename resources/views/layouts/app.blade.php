...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/custom.css', 'resources/css/animations.css', 'resources/css/theme.css'])
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        <h1 class="text-xl font-bold text-indigo-600">SMS Manager</h1>
                    </div>
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    <div class="ml-3 relative">
                        <div>
                            <button type="button" class="flex items-center text-sm text-gray-700 hover:text-gray-800 focus:outline-none" id="user-menu" aria-expanded="false" aria-haspopup="true">
